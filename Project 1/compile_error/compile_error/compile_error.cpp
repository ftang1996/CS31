...
int main()
{
    ...
    double pctApprove = 100.0 * numApprove / numSurveyed    // no semicolon
    pctDisapprove = 100.0 * numDisapprove / numSurveyed;    // didn't declare variable type
    ...
    cout << pctDisapprove << "% say they dispprove." << endl;
